...
Rubik.prototype.randomize = function() {
	...
	var cb = function() {
		...
		if (remain > 0) { 
			...
			this._help.a = OZ.DOM.elm("p", {innerHTML:"Drag or slide the background to rotate the entire Rubik's Cube."});
			this._help.b = OZ.DOM.elm("p", {innerHTML:"Drag or slide the Rubik's Cube to rotate its various layers."});
