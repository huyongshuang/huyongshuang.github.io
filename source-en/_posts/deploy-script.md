...
* Before using it, please change the folder name where you store your Hexo project files to 'Blog', and place the following 'bat' files in the same directory as' Blog '. You can customize your file name and location in the code below.

# 1. Hexo Local Deployment Script

Click to <a href="{% asset_path Hexo-本地部署.bat %}" download="Hexo 本地部署.bat">**download**</a> the `Hexo Local Deployment.bat` file.

```bat
wt -d "Blog" cmd /k "hexo clean & hexo generate & hexo server"
```

# 2. Hexo Deployment to GitHub Pages Script

Please install `hexo-deployer-git` and configure Hexo properly. Click to <a href="{% asset_path Hexo-部署到-GitHub-Pages.bat %}" download="Hexo 部署到 GitHub Pages.bat">**download**</a> the `Hexo Deploy to GitHub Pages.bat` file.
...
Click to <a href="{% asset_path Git-推送脚本.bat %}" download="Git 推送脚本.bat">**download**</a> the `Git Push Script.bat` file.
