function initCalendarWidget() {
	...
	function getAirLevel(aqi) {
		...
		if (aqi <= 150) return "Moderate pollution";
		if (aqi <= 200) return "Moderately heavy pollution";
		if (aqi <= 300) return "Heavy pollution";
