...
keywords:
description: The playlist is updated irregularly. Thank you!
comments:
top_img:
aside:
---
    ...
    <div class="player-inner">
        <div class="main-content">
            <div class="music-list-container" id="musicListContainer">
                ...
                <h2><i class="fa-solid fa-music"></i> Music List</h2>
            ...
            <div class="right-content">
                <div class="album-section">
                    ...
                    <div class="album-info">
                        <h1 class="now-playing-title" id="nowPlayingTitle">Choose a song</h1>
                        <p class="now-playing-artist" id="nowPlayingArtist">-</p>
                        <p class="album-status" id="albumStatus">Click the play button to start the playback.</p>
                    </div>
                </div>
        ...
        <div class="player-controls">
            ...
            <div class="controls-main">
                ...
                <div class="right-controls">
                    ...
                    <button class="loop-btn" id="loopBtn" title="Loop play">
                        <i class="fa-solid fa-arrow-rotate-right"></i>
                    </button>
                    <button class="speed-btn" id="speedBtn" title="Play speed">
                        <span>1.0x</span>
                    </button>
                    <button class="theme-btn" id="themeBtn" title="Auto Background">
...
(function() {
    ...
    async function loadMusicData() {
        try {
            ...
            if (ymlRes.ok) {
                ...
                if (typeof jsyaml === 'undefined') throw new Error('The js-yaml library is not loaded');
                const config = jsyaml.load(yamlText);
                if (config && config.songs && config.songs.length > 0) {
                    musicData = config.songs;
                    console.log('YAML configuration file loaded');
                    return;
                }
            }
            throw new Error('Invalid or non-existent YAML configuration');
        } catch (ymlError) {
            console.warn('Failed to load YAML configuration, attempting to load JSON configuration:', ymlError.message);
        }
        ...
        try {
            ...
            throw new Error('Invalid or non-existent JSON configuration');
        } catch (jsonError) {
            console.warn('Failed to load JSON configuration, default data will be used:', jsonError.message);
        }
        ...
        `;
        errorTip.textContent = 'Failed to load configuration, using default music';
    ...
    function initMusicList() {
        ...
        musicData.forEach((music, index) => {
            ...
            item.innerHTML = `
                ...
                <div class="music-duration">${musicDurations[index] ? formatTime(musicDurations[index]) : 'Loading...'}</div>
            `;
            item.addEventListener('click', () => {
                if (index === currentMusicIndex) {
                    ...
                    audioPlayer.play().then(() => {
                        ...
                        albumStatus.textContent = 'Playing';
    ...
    async function selectMusic(index) {
        ...
        albumStatus.textContent = isPlaying ? 'Playing' : 'Suspended';
    ...
    function toggleTheme() {
        if (themeMode === 'auto') {
            ...
            themeBtn.title = 'White Background';
    ...
    function initEvents() {
        ...
        audioPlayer.addEventListener('pause', () => {
            ...
            albumStatus.textContent = 'Suspended';
            updateAlbumCoverRotation();
        });
    ...
    function initApp() {
        ...
        loadMusicData().then(() => {
            if (musicData.length > 0) {
                ...
                nowPlayingTitle.textContent = 'Failed to load music';
                nowPlayingArtist.textContent = 'Please check the configuration file';
            }
        });
    }
